...
const TextareaInput = ({
  ...
  return (
    <div className="relative w-full">
      ...
      <label
        htmlFor={id}
        className={`cursor-text peer-focus:cursor-default absolute left-2 -top-2 z-[1] px-2 text-[14px] text-[#4c4c4e] transition-all before:absolute before:top-0 before:left-0 before:z-[-1] before:block before:h-full before:w-full before:bg-white before:transition-all ${
